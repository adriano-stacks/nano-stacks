...
(module
    ...
    (import "clarity" "enter_restrict_assets" (func $stdlib.enter_restrict_assets (result externref)))
    (import "clarity" "exit_restrict_assets" (func $stdlib.exit_restrict_assets (param i32) (param i32) (param externref) (result i64 i64 i32)))
    ...
    (import "clarity" "with_ft" (func $stdlib.with_ft (param externref)
                                                      ...
                                                      (param $amount_lo i64)
                                                      (param $amount_hi i64)))
    (import "clarity" "with_nft" (func $stdlib.with_nft (param externref)
                                                        (param $contract_id_offset i32)
                                                        (param $contract_id_length i32)
                                                        (param $token_name_offset i32)
                                                        (param $token_name_length i32)
                                                        ...
                                                        (param $identifiers_ty_length i32)))
    ...
    (import "clarity" "secp256k1_verify" (func $stdlib.secp256k1_verify (param $msg_offset i32)
                                                                 ...
                                                                 (param $pk_length i32)
                                                                 (result i32)))
    (import "clarity" "secp256r1_verify" (func $stdlib.secp256r1_verify (param $msg_offset i32)
                                                                 (param $msg_length i32)
                                                                 (param $sig_offset i32)
                                                                 (param $sig_length i32)
                                                                 (param $pk_offset i32)
                                                                 (param $pk_length i32)
                                                                 (result i32)))
    (import "clarity" "ed25519_verify" (func $stdlib.ed25519_verify (param $msg_offset i32)
                                                               (param $msg_length i32)
                                                               (param $sig_offset i32)
                                                               (param $sig_length i32)
                                                               (param $pk_offset i32)
                                                               (param $pk_length i32)
                                                               (result i32)))
    (import "clarity" "secp256k1_decompress" (func $stdlib.secp256k1_decompress (param $pk_offset i32)
                                                                           (param $pk_length i32)
                                                                           (param $result_offset i32)
                                                                           (param $result_length i32)))
    (import "clarity" "verify_merkle_proof" (func $stdlib.verify_merkle_proof (param $leaf_offset i32)
                                                                         (param $leaf_length i32)
                                                                         (param $root_offset i32)
                                                                         (param $root_length i32)
                                                                         (param $index_lo i64)
                                                                         (param $index_hi i64)
                                                                         (param $count_lo i64)
                                                                         (param $count_hi i64)
                                                                         ...
                                                                         (result i32)))
    (import "clarity" "get_bitcoin_tx_output" (func $stdlib.get_bitcoin_tx_output (param $tx_offset i32)
                                                                           (param $tx_length i32)
                                                                           (param $vout_lo i64)
                                                                           (param $vout_hi i64)
                                                                           (param $result_offset i32)
    ...
    (import "clarity" "contract_caller" (func $stdlib.contract_caller (param $return_offset i32)
                                                               (param $return_length i32)
                                                               (result i32 i32)))
    (import "clarity" "current_contract" (func $stdlib.current_contract (param $return_offset i32)
                                                               (param $return_length i32)
                                                               (result i32 i32)))
