---
id: "072"
title: "contract-hash refuses a contract with large argument types"
status: pending
priority: high
effort: medium
dependencies: []
...
- [ ] Reproduce with the minimal input alone, outside the property, so the failure
      is a fixture rather than a seed.
